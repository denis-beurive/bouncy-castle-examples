...
* If string-to-key usage octet was 255 or 254, a [string-to-key specifier](https://tools.ietf.org/html/rfc4880#section-3.7).
  ...
  * Octets 2-9: salt value is `9F 19 C8 66 F9 DF 00 F4`.
  * Octet 10: `0x60` (`96`) count, a one-octet, coded value. 
...
* Packet body: `0x5EB2CE3B` = `1588776507` => Wednesday 6 May 2020 14:48:27
